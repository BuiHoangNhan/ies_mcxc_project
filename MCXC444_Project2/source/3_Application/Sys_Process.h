...
#define ALERT_VOLTAGE_GET      (Sensor_get_value()->BL0942_sensor_data.voltage > UserData_getPointer()->Node_userConfig.vol_thres)
#define ALERT_CURRENT_GET      (Sensor_get_value()->BL0942_sensor_data.current > UserData_getPointer()->Node_userConfig.current_thres)
#define ALERT_POWER_GET        (Sensor_get_value()->BL0942_sensor_data.power > UserData_getPointer()->Node_userConfig.power_thres)
